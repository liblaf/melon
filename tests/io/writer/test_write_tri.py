...
# TODO: this test currently fails for .obj, .stl formats due to ordering
@pytest.mark.parametrize("suffix", [".ply", ".vtp"])
...
# TODO: fix this test
@pytest.mark.skip
@pytest.mark.parametrize("suffix", [".obj", ".ply", ".stl", ".vtp"])
